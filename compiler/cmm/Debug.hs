...
cmmDebugLink :: [Label] -> BlockEnv [UnwindPoint] -> [DebugBlock] -> [DebugBlock]
...
-- with. Note a register's value will be 'Nothing' when the register's
-- previous value cannot be reconstructed.
