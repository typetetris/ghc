...
data CmmNode e x where
  ...
  CmmUnwind :: !Label -> !GlobalReg -> !CmmExpr -> CmmNode O O
...
mapExp f   (CmmUnwind lbl r e)                   = CmmUnwind lbl r (f e)
...
mapExpM f (CmmUnwind lbl r e)       = CmmUnwind lbl r `fmap` f e
...
foldExp f (CmmUnwind _ _ e) z                     = f e z
