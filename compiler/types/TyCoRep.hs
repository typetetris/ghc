...
pprTypeDebug :: Type -> SDoc
pprTypeDebug (TyVarTy var) = text "TyVarTy:"<+>ppr var
pprTypeDebug (AppTy a b)   = text "AppTy" $$ nest 2 (pprTypeDebug a $$ empty $$ pprTypeDebug b)
pprTypeDebug (TyConApp tc tys) = text "TyConApp:" <+> ppr tc $$ nest 2 (vcat $ map pprTypeDebug tys)
pprTypeDebug (ForAllTy bndr t) = text "ForAllTy:" <+> ppr bndr $$ nest 2 (pprTypeDebug t)
pprTypeDebug (FunTy a b) = text "FunTy" $$ nest 2 (pprTypeDebug a $$ pprTypeDebug b)
pprTypeDebug (LitTy lit) = text "LitTy:" <+> ppr lit
pprTypeDebug (CastTy ty co) = text "CastTy:" <+> ppr co $$ nest 2 (pprTypeDebug ty)
pprTypeDebug (CoercionTy co) = text "CoercionTy:" <+> ppr co
